...
<main class="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 py-8 space-y-5">
    ...
    <section class="panel p-4 space-y-3">
        ...
        <form method="post" class="grid sm:grid-cols-4 gap-2 rounded-2xl border border-white/10 bg-white/[0.03] p-3">
            ...
            <button class="sm:col-span-4 px-3 py-2 rounded-xl text-sm font-semibold bg-blue-600 hover:bg-blue-700">Ajouter l'application</button>
        </form>
        ...
        <div class="space-y-2">
            ...
            <div class="card rounded-lg bg-white/[0.03] border border-white/10 p-2">
                <form method="post" class="grid sm:grid-cols-6 gap-2">
                    <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($_SESSION['csrf_token']) ?>">
